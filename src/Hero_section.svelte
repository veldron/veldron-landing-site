...
<SvelteSeo
  title="Get your MVP to Market in Record Time"
...
<div class="bg-gray-300">
  <div
    class=" flex flex-col max-w-7xl m-auto items-center p-8 md:p-20 lg:py-32
    lg:px-52">
          ...
          <div class="flex flex-col md:flex-row gap-4">
            <!-- <div class="relative">
              ...
              <div class="absolute top-2 right-2">
                <button
                  class=" bg-primary-dark hover:bg-primary text-white font-bold
                  py-2 px-5 rounded-full">
                  Contact me
                </button>
              </div>
            </div> -->
          <a target="_blank" href="https://cal.com/insanebaba/short-meet"
                class="flex h-14 text-center items-center flex-row justify-center w-full gap-4 bg-primary-dark hover:bg-primary text-white font-bold
                py-2 px-8 rounded-full">
                Book a meeting <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
