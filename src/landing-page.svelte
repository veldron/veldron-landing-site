...
<div class="font-serif">
  ...
  <div class=" w-full">
    ...
    <div class="mt-2 items-center justify-center">
      <!-- <h1
        class="text-black-500 py-12 px-10 md:text-5xl text-4xl font-bold
        text-center">
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          ...
          <div
            class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12
            md:space-y-0">
            <div>
              <div
            ...
            <div>
              ...
              <p class="text-gray-500 dark:text-gray-400">
                With Veldron, you don't have to pay to development, programming,
              ...
              <div
                ...
                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none">
                  <path
                    ...
                    6.15436L12.8345 3.16228Z"
                    fill="white" />
                  <path
                    d="M7.89848 14.2357L7.88524 14.2487L6.91116 15.2166L6.89837
                    ...
                    fill="white" />
                  <path
                    d="M7.60772 15.9344C7.26849 16.2852 7.27276 16.8428 7.62053
                    ...
                    14.9407L8.59505 14.9535L7.62097 15.9214L7.60772 15.9344Z"
                    fill="white" />
                  <path
                    d="M5.50058 11.4079C5.85268 11.7578 5.85268 12.325 5.50058
                    ...
                    fill="white" />
                  <path
                    d="M11.8542 16.9253C12.2063 17.2752 12.2063 17.8424 11.8542
                    ...
                    16.5755 11.8542 16.9253Z"
                    fill="white" />
                  <path
                    d="M5.3439 4.83107C6.73954 3.44435 8.63783 2.86145 10.456
                    ...
                    10.5451C3.23454 8.55553 3.78374 6.38124 5.3439 4.83107Z"
                    fill="white" />
                </svg>
            ...
            <div>
              <div
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1
                    0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2
                    2 0 01-2 2H4a2 2 0 01-2-2v-4z" />
                </svg>
              </div>
              <h3 class="mb-2 text-xl font-bold dark:text-white">
                Enterprise Design
    ...
    <div class="flex flex-col pl-10 md:flex-row ">
      <div>
        ...
        <h1 class=" text-black-500 py-12 px-10 font-bold text-4xl text-center">
          It’s Everything You’ll Ever Need.
        </h1>
        <p class=" text-slate-500 text-left text-xl ">
        ...
        <div class="flex flex-row items-center justify-center mt-8">
          <button
            class=" bg-primary-dark hover:bg-primary text-white font-bold py-4
            px-10 rounded-full">
            Explore
          </button>
        </div>
    ...
    <div>
      <div>
        <div class="flex flex-col md:flex-row py-16">
          ...
          <div class="mt-5 p-10">
            <h3 class="text-black-500 text-xl font-bold py-12 text-left">
              USER INTERFACE
            </h3>
            <h1
              class="text-black-500 md:text-4xl text-3xl font-bold py-4
              text-center">
            ...
            <div class="flex flex-row items-center justify-center mt-8">
              <button
                class="flex flex-row bg-primary-dark hover:bg-primary
                items-center text-white font-bold py-4 px-10 rounded-full">
                Explore
              </button>
            </div>
          </div>
    ...
    <div class="bg-primary-dark p-12 rounded-lg">
      ...
      <div class="grid grid-cols-2 gap-2 bg-white py-2 px-3 mt-12">
        <div class="flex flex-col items-center">
          <div class="flex flex-row justify-center w-full">
            <img
              src="https://oliver-tailwind.netlify.app/assets/images/icon/pen&ruller.svg"
              alt="" />
            <h2 class="text-black-500 font-bold text-xl text-center">
              Well Documented
            </h2>
          </div>
          <p class="text-black-500 text-zinc-500 text-xl text-center">
        ...
        <div>
          <div class="flex flex-row justify-center w-full">
            <img
              src="https://oliver-tailwind.netlify.app/assets/images/icon/code.svg"
              alt="" />
            <h2 class="text-black-500 font-bold text-xl text-center">
              Highly Customizable
            </h2>
          ...
          <p class="text-black-500 text-zinc-500 text-xl text-center">
            The point of using Lorem Ipsum is has a normal distribution of
        ...
        <div>
          <div class="flex flex-row justify-center w-full">
            <img
              src="https://oliver-tailwind.netlify.app/assets/images/icon/headphones.svg"
              alt="" />
            <h2 class="text-black-500 font-bold text-xl text-center">
              24/7 Support
            </h2>
          </div>
          <span class="text-black-500 text-zinc-500 text-xl text-center">
        ...
        <div class="">
          <div class="flex flex-row justify-center w-full">
            <img
              src="https://oliver-tailwind.netlify.app/assets/images/icon/groupchat.svg"
              alt="" />
            <h1 class="text-black-500 font-bold text-xl text-center">
              Community
            </h1>
          </div>

          <span class="text-black-500 text-zinc-500 text-xl text-center">
            If you are going to use a Ipsum, you need to be sure there isn't
            anything in the middle of text.
          </span>
        </div>
      </div>
    </div>
    <div class=" items-center m-10 md:py-44 md:px-52">
      <div class="flex flex-row justify-center w-full" />
      <h1 class="text-black-500 font-bold text-5xl mt-8 text-center">
        Hosts Like You, Worldwide
      </h1>
      <p class="text-xl text-zinc-500 mt-5">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis eum
        modi, adipisci facilis.
      </p>
      <!-- Rating cards -->
      <div
        class="flex flex-col py-8 md:flex-row items-center justify-center
        space-x-16 ">
    ...
    <div class="bg-primary-dark py-40 rounded-lg">
      <h1 class=" text-white text-5xl md:text-7xl font-bold text-center">
        We’re Ready for a Challenging Project
      </h1>
      <p class="text-white text-black-500 py-10 m-7 text-xl text-center">
        The point of using Lorem Ipsum is that opposed to using 'Content here,
        content here', making it look like readable English.
      </p>
      <div class="flex flex-row w-full items-center justify-center">
        <button
          class=" max-w-sm bg-white font-bold text-black-500 py-2 px-4
          rounded-full">
          start trial free
        </button>
      </div>
    ...
    <div class=" py-20 ml-8 ">
      ...
      <p class=" text-slate-500 py-10 text-xl text-center">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis eum
        modi, adipisci facilis.
      </p>
      ...
      <div class="flex md:flex-row flex-col ml-20 space-x-10">
        <div class="ml-10">
          <button
            class="bg-primary-dark hover:bg-primary items-center text-white
            font-bold py-3 px-14 rounded-full">
            Step1
          </button>
          <h1 class="font-bold text-2xl py-3">Design & Devloping</h1>
          <p class=" text-slate-500 md:text-xl ">
    ...
    <div class="py-56 ml-8">
      ...
      <p class=" text-slate-500 text-black-500 py-10 text-2xl text-center">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis eum
        modi, adipisci facilis.
      </p>
      <!-- create cards -->
    ...
    <div class="ml-8">
      ...
      <div class=" space-x-8 mt-16 ">
        <div
          class="flex flex-col md:flex-row md:items-between md:justify-between">
          <div class="max-w-sm rounded overflow-hidden shadow-2xl">
            <div class="px-20 py-20">
              <div class="font-bold text-3xl mb-2">Basic</div>
              <p class="text-gray-700 py-16 text-xl ">
            ...
            <div class="max-w-sm rounded overflow-hidden shadow-2xl">
              <div class="px-20 py-20">
                ...
                <button
                  ...
                  text-white font-bold py-3 px-14 rounded-full">
                  Choose Now
                </button>
                <div class=" py-6 ">
          ...
          <div class="mt-6">
            <div class="max-w-sm rounded overflow-hidden shadow-2xl">
              <div class="px-20 py-20">
                ...
                <p class="text-gray-700 md:py-16 py-10 text-xl">
                  Start building beautiful websites.
                </p>
                <button
                  class="bg-primary-dark hover:bg-primary items-center
    ...
    <div class=" bg-primary-dark mt-10 rounded-lg ">
      <h1 class="font-bold text-white py-20 text-5xl text-center ">
      ...
      <div class=" flex flex-row items-center mt-10 justify-center">
        <form
          action=""
          class=" bg-white rounded-lg outline-double outline-stone-400 ">
          <div class="mt-4">
    ...
    <div class="flex flex-row w-full items-center justify-center">
      <button
        class=" max-w-sm bg-primary-dark hover:bg-purple-600 text-white
        font-bold text-black-500 py-2 px-4 rounded-lg ">
        Send Message
      </button>
    </div>

    <div
      class="flex flex-col ml-20 md:flex-row items-between justify-between py-40
      px-6 pl-9 space-x-10">
      <div class="">
    ...
    <div class="flex ">
      <div
        class="flex flex-col md:flex-row items-center justify-center space-x-16 ">
        ...
        <div>
          ...
          <div class="flex flex-col">
            <span
              class=" text-slate-500 py-2 text-black-500 text-2xl text-center">
              Getbootstrap
            </span>
            <span class=" text-slate-500 py-2 text-xl text-center">
              Wordpress
            </span>
            <span class=" text-slate-500 py-2 text-xl text-center">
              Shopify
        ...
        <div>
          ...
          <div class="flex flex-col">
            ...
            <span
              class="text-slate-500 text-black-500 py-2 text-xl text-center">
              Terms
            </span>
            <span
              class=" text-slate-500 text-black-500 py-2 text-xl text-center">
        ...
        <div>
          ...
          <div class="flex flex-col">
            ...
            <span class="text-slate-500 text-black-500 text-xl text-center">
              Design
            </span>
            <span class="text-slate-500 text-black-500 text-xl text-center">
              Themes
